export default function About() {
  return (
    <div>
      <h2 className="font-['Syne'] text-[clamp(2rem,4vw,3rem)] font-bold tracking-tight leading-[1.1] mb-6 text-white">
        About Me
      </h2>
      <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-4">
        <div className="space-y-3">
          <p className="text-white leading-relaxed text-sm">
            Hello, I&apos;m <strong className="text-white font-medium">Thai Duong (David) Nguyen</strong>, a Software Development student at SAIT.
          ...
          <p className="text-white leading-relaxed text-sm">
            Outside of tech, I enjoy <strong className="text-white font-medium">piano, chess, and exploring history, philosophy, and astronomy</strong>.
          </p>
        </div>
      </div>
    </div>
